intro.addEventListener('click',function(){
    ...
    document.getElementById("image-citation").innerHTML="Figure 1: The Stone Age. Source: Adapted from [5]";
...
paleolithic.addEventListener('click',function(){
    ...
    document.getElementById("image-citation").innerHTML="Figure 2: The Paleolithic Era. Source: Adapted from [6]";
...
mesolithic.addEventListener('click',function(){
    ...
    document.getElementById("image-citation").innerHTML="Figure 3: The Mesolithic Era. Source: Adapted from [6]";
...
neolithic.addEventListener('click',function(){
    ...
    document.getElementById("image-citation").innerHTML="Figure 4: The Neolithic Era. Source: Adapted from [6]";
